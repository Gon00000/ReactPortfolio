    ...
    return (
        <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
            ...
            <div className="flex flex-col items-start">
                ...
                initial="hidden"
                animate="visible"
                transition={{delay: 1.2}}><FlipWords words={word} className="font-black text-white text-8xl"/>
                    </motion.div>

                    <motion.p className="text-4xl font-medium text-neutral-300" variants={variants}
                initial="hidden"
                animate="visible"
                transition={{delay: 1.3}}>Web Solution</motion.p>
                    </div>      
            ...
            {/* Mobile */}
            <div className="flex-flex-col space-y-6 md:hidden" variants={variants}
                initial="hidden"
                animate="visible"
                transition={{delay: 1}}>
                ...
                initial="hidden"
                animate="visible"
                transition={{delay: 1.1}}>Hi I'm Psalmer</motion.p>
            <div>
           ...
           <motion.div variants={variants}
                initial="hidden"
                animate="visible"
                transition={{delay: 1.3}}><FlipWords words= {word}/>
           <motion.p className="text-4xl font-black text-neutral-300" variants={variants}
                initial="hidden"
                animate="visible"
                transition={{delay: 1.4}}>Web Application</motion.p>
           </motion.div>
           </div></div> </div>
    )
    }
